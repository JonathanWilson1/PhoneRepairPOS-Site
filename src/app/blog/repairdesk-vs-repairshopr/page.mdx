...
If you are at the bottom of the diagram — solo operator, small team, just want to stop using a notebook — skip the rest of this article and [download PhoneRepairPOS for free](https://apps.apple.com/app/phone-repair-pos/id6759859240). The other two are great tools, but you will be paying $1,800 to $7,000 a year for features you never touch.
...
- Your customer data works offline on your device and syncs to your own private cloud account — never sold, never shared for advertising
