...
export const metadata = {
  ...
  description: 'How to price phone repairs profitably — the formula, typical markups by repair type, and the mistakes that quietly kill your margins.',
...
# Phone Repair Pricing Guide 2026: Real Margins by Repair Type
