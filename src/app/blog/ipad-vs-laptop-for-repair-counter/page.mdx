...
That is why we built [PhoneRepairPOS, our free POS app for cell phone repair shops](/), as an iPad-first app for the counter — and it runs just as well on iPhone for techs working on the move. It is designed for touch, optimised for the counter, and fast enough that intake takes under 30 seconds. The interface is purpose-built for the iPad screen, not a shrunken desktop app.
